...
- Try out this latest feature of manipulating output during runtime:
  ...
  - to specify additional color reference (the characters or substring to be coloured); use `--reff=<your ref>` for instance, `reff=come`. This adds "come" to the reference list.
